// lib/widgets/module_grid_view.dart
import 'package:flutter/material.dart';
import 'package:flutter_riverpod/flutter_riverpod.dart';
import 'package:test123/providers/library_providers.dart';
import 'package:test123/widgets/module_card_grid.dart';

class ModuleGridView extends ConsumerWidget {
  const ModuleGridView({super.key, required this.id, required this.role});
  final String id;
  final String role;
